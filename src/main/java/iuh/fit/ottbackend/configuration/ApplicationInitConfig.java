...
public class ApplicationInitConfig {
    ...
    ApplicationRunner applicationRunner(UserRepository userRepository) {
        return args -> {
            ...
            if (userRepository.findByPhone("0987654321").isEmpty()) {
                ...
                log.info("📱 Phone: 0987654321");
                log.info("🔑 Password: admin123");
            }

            // Create additional test users for various scenarios
    ...
    private void createTestUsers(UserRepository userRepository) {
        ...
        if (userRepository.findByPhone("0911111111").isEmpty()) {
            ...
            log.info("✅ Blocked test user created - Phone: 0911111111");
        }
        ...
        if (userRepository.findByPhone("0922222222").isEmpty()) {
            ...
            log.info("✅ Inactive test user created - Phone: 0922222222");
        }

        // User 4 - User with Google account linked
        if (userRepository.findByPhone("0933333333").isEmpty()) {
            ...
            log.info("✅ Google test user created - Phone: 0933333333");
        }
