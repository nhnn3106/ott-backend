...
import iuh.fit.ottbackend.service.QrLoginService;
...
public class QrLoginController {
    ...
    public ApiResponse<QrCodeResponse> generateQrCode(
        ...
        log.info("QR code generated for device: {}", request.getDeviceId());
    ...
    public ApiResponse<QrStatusResponse> scanQrCode(
        ...
        log.info("QR code scanned by user: {}", userId);
    ...
    public ApiResponse<QrStatusResponse> confirmQrLogin(
        ...
        log.info("QR login {} by user: {}",
                request.isConfirmed() ? "confirmed" : "rejected", userId);
